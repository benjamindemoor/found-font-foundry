      ...
      >
        ...
        <header className="mb-12">
          ...
          <p className="text-base text-gray-700" style={{ marginBottom: '2em' }}>
            ...
            Add your own finds via the <a href="https://www.are.na/benjamin-ikoma/found-fonts-foundry" target='_blank' rel='noopener noreferrer' className='underline'>Found Fonts Foundry are.na channel</a>. 
