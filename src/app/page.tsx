...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-white px-4 py-6 pb-16">
      <div className="max-w-5xl mx-auto responsive-container" style={{ marginLeft: '2em', marginRight: '2em', marginTop: '1.5em' }}>
        ...
        {loading && currentPage === 1 ? (
          ...
          <>
            {loading ? (
              <div className="loading-indicator text-center py-4">Loading more images...</div>
            ) : null}
